...
class SignInDemoWidget extends StatefulWidget {
  ...
  @override
  _SignInDemoWidgetState createState() => _SignInDemoWidgetState();
}

class _SignInDemoWidgetState extends State<SignInDemoWidget> {
  late SignInDemoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SignInDemoModel());
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text(
                          'Sign into your account and experience \nwhat everyone\'s been listening to.',
